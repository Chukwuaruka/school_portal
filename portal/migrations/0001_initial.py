# Generated by Django 5.2.2 on 2025-09-10 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='portal.classroom')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='portal.classroom')),
            ],
        ),
        migrations.CreateModel(
            name='Announcement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session', models.CharField(blank=True, choices=[('2023/2024', '2023/2024'), ('2024/2025', '2024/2025')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manual_grade', models.CharField(blank=True, max_length=10)),
                ('grade_comment', models.TextField(blank=True)),
                ('first_term_score', models.PositiveIntegerField(blank=True, null=True)),
                ('second_term_score', models.PositiveIntegerField(blank=True, null=True)),
                ('average_score', models.FloatField(blank=True, null=True)),
                ('report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subject_grades', to='portal.gradereport')),
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['subject'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='portal.classroom')),
